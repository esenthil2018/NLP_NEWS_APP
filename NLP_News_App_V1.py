...
def full_text(my_url):
    ...
    # Test url
    # url = 'https://www.southbendtribune.com/sports/professional/fans-may-not-like-what-they-see-on-return-to-stands/article_07753c3e-bc97-11ea-9f7a-131fe6f04dad.html'
...
st.title('NLP App - Sentiment Analysis')

st.markdown("""
This app displays the news articles appeared in the top 5 News Publications!
* **Does a sentiment analysis**
* **Displays top 10 words, unigrams, bigrams and trigrams.**
* ** Also does topic modeling**
""")
...
lnlp = ["Intro","Snapshot","Unigrams","Bigrams","Trigrams","WordCloud","Topic Modeling","LDA","Entity Extraction","Sentiment Analysis TextBlob","Sentiment Analysis-Vader","Text Summarization"]
...
def load_data(news,nlp):
   if news =="NY Times":
       ...
       if nlp =="Intro":
           ...
           image = Image.open(r'C:\BPC_DOCS\IUB\Projects_Medium\New-York-Times-logo-500x281.png')
       ...
       if nlp == "Snapshot":
           st.header('Display the dataframe')
           st.dataframe(df)
           st.markdown("""**The no of articles :**""")
           st.write(df.shape[0])
